...
- [x] **VN30 macro regime filter** — basket VN30 equal-weight, EMA50; chặn BUY mới khi basket ≤ basket EMA50 *(commit pending — impact đo sau re-baseline)*
...
|------|----------|--------|---------|
| 2026-04-19 | VN30 macro regime filter (roadmap 3.1) | *(pending)* | Basket VN30 equal-weight + EMA50; `core/market_regime.py`. Chặn BUY khi basket ≤ EMA50 |
